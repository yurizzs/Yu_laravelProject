                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full min-w-full">
                            ...
                            <tbody class="divide-y divide-neutral-200 dark:divide-neutral-700">
                                @forelse ($students as $student)
                                    <tr class="transition-colors hover:bg-neutral-50 dark:hover:bg-neutral-800/50">
                                        ...
                                        <td class="px-4 py-3 text-sm">
                                            ...
                                            <form class="inline" onsubmit="return confirm('Are you sure you want to delete this student?')">
                                                @csrf
                                                @method('DELETE')
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="px-4 py-3 text-center text-sm text-neutral-600 dark:text-neutral-400">No students found. Add your first student above!</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
